...
% The inherited v1 numerical and stylized-application narrative is retained
% below only as source provenance during revision; it is excluded from the
% definitive v2 build because its figures and claims are not part of the dated
% final evidence release.
\iffalse

We empirically examine consequences of the structural and certification analysis developed in
\Cref{sec:structure,sec:algorithm,sec:exact}:
